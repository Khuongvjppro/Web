    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
          			<a href="${pageContext.request.contextPath}/dashboard" class="fa fa-desktop">Dashboard</a>
        		</li>
        		<li>
          			<a href="${pageContext.request.contextPath}/html_admin/admin_user.jsp" ><i class="active-link"></i>USER<span class="badge"></span></a>
        		</li>
        		<li>
